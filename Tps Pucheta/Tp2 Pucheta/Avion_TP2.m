...
% % %--------------------------------------------------------------------------
% % %3/ Avion con controlador,integrador y referencia.
% % %-------------------------------------------------------------------------
% clear all;
% T=70; Kmax=100000; At=T/Kmax;
% t=0:At:T-At;
...
%--------------------------------------------------------------------------
%Avion con observador,FUNCIONA CON OBSERVADOR, pero no funciona SIN
%OBSERVADOR. Con polos a lazo cerrado en -15+/-15i ; -.5+/-.5i
%-------------------------------------------------------------------------
% clear all;
...
%--------------------------------------------------------------------------
%Avion con observador,FUNCIONA CON OBSERVADOR, pero no funciona SIN
%OBSERVADOR. Con polos a lazo cerrado mui(1)=-50;mui(2)=-30; mui(3)=-1 + 1i;mui(4)=-1 - 1i;
%-------------------------------------------------------------------------
clear all;
T=70; Kmax=10000; At=T/Kmax;
u=zeros(Kmax);y=u;yp=y; t=0:At:T-At;
