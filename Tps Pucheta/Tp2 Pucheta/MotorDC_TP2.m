% % %---------------------------------------------------------------------------
% % %TP2 1.1 / Primer intento (ESTA MAL) con un PID
% % %---------------------------------------------------------------------------
% clear all;close all;
...
% %---------------------------------------------------------------------------
% %Tp2_ 1.2 / Modelo del motor con matrices pero sin control.
% %---------------------------------------------------------------------------
% clear all;close all;
...
% mui(1)=-50000000;mui(2)=-50000000; mui(3)=-50000000;
...
%  end
%  %u=u+A1*e(k)+B1*e(k-1)+C1*e(k-2); %PID
%  %u=-K*estado; color='b'; %Sin Observador
%  %u=-K*x_hat; color='r'; %Con Observador
% 
%  x1(ii)=X(1);%tita
%  x2(ii)=X(2);%omega
%  x3(ii)=X(3);%ia
...
% %---------------------------------------------------------------------------
% %Punto 1.1 / No funciona el controlador, no se exactamente el porque.
% %---------------------------------------------------------------------------
% clear all;close all;
...
% %---------------------------------------------------------------------------
% %Tp2_Punto 1.1 / Sistema con control y la referencia variable,funciona
% aunque la acc queda un poco grande.
% %---------------------------------------------------------------------------
% clear all;%close all;
...
% %---------------------------------------------------------------------------
% %Tp2_Punto 1.2 / Sistema con observador y sin observador, ambos funcionan
% aunque la acc queda un poco grande.
% %---------------------------------------------------------------------------
clear all;%close all;
X=[0; 0; 0];ii=0;At=1e-5;ref1=-1.57;ref2=1.57;tF=0.9;
