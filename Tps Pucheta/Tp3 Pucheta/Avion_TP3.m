...
%-------------------------------------------------------------------------
% % %-----------------------------------------------------------------------------
% Avion Con observador e integrador DLQR. El que hice yo, sin correcciones
% del profe.
% %---------------------------------------------------------------------------
% clear all;%close all;
% TamanioFuente=12;
...
% Oc=[C; C*Ac; C*Ac^2; C*Ac^3];%Matriz Observabilidad
% auto_O=eig(Oc);
% rango_O=rank(Oc);
...
%Funcional de costos
%Qc=diag([.899 .889 .978 .999 .9899 .8899]); R=4.498e9; %Ts=0.01; %Valor Con alinealidad .25 
                                           %%%%
% Qc=diag([.899 .889 .978 .999 .9899 .8899]); R=5.5e9; %Qc=diag([.899 .889 .978 .999 .9899 .8899]); R=4.498e9;; 
%Qc=diag([.899 .889 .978 .999 .9899 .8899]); R=2.019e11; 
