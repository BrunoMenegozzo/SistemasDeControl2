...
%----------------------------------------------------------------------------
%Falta que Xop se coloque como corresponde en
...
figure(1);hold on;
subplot(3,2,1);plot(t,omega,color); plot(t,omega_,color);title('Velocidad angular');grid on;
subplot(3,2,2);plot(t,alfa,color);plot(t,alfa_,color);title('Angulo pendulo');grid on;
subplot(3,2,3); plot(t,p,color); plot(t,p_,color);title('Desplazamiento Carro');grid on;
subplot(3,2,4);plot(t,p_p,color); plot(t,p_p_,color);title('Velocidad Carro');grid on;
